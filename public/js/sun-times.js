/* SNORKY sun-times.js — 브라우저 전역 노출용
 * 원본: api/_lib/sun-times.js (Node.js CommonJS)
 * 동일 NOAA 태양 방정식, 동일 로직 — module.exports → window.calculateSunTimes
 */
(function(){
"use strict";
const cache=new Map();
...
window.calculateSunTimes=calculateSunTimes;
})();
