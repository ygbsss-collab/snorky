...
const existingHomeHero=document.getElementById("homeHero");if(existingHomeHero&&!section.contains(existingHomeHero))section.insertBefore(existingHomeHero,section.firstChild);
if(!section.querySelector("#homeHero"))section.insertAdjacentHTML("afterbegin",`<section id="homeHero" class="home-hero" style="background-image:url('./public/images/snorky-hero-freediving.jpg')"><div class="home-hero-shade"></div><div class="home-hero-content"><div class="home-hero-header" style="display:flex;align-items:center;width:100%"><div class="home-hero-brand brand-mark" role="button" tabindex="0" aria-label="SNORKY 로고" style="cursor:pointer"><img src="./public/images/snorky-symbol.png" alt="SNORKY" class="home-hero-logo"><span class="home-hero-brand-name">SNORKY</span></div></div><div class="home-hero-body"><h1 class="home-hero-title">오늘, 어디 바다로 갈까?</h1><p class="home-hero-subtitle">바다 날씨부터 함께할 버디까지, SNORKY 에서 찾아보세요.</p></div></div></section>`);
const existingWarning=document.getElementById("homeMarineWarning");if(existingWarning&&!section.contains(existingWarning)){const hero=section.querySelector("#homeHero");if(hero)hero.insertAdjacentElement("afterend",existingWarning);else section.appendChild(existingWarning);}
if(!section.querySelector("#homeMarineWarning")){const hero=section.querySelector("#homeHero");if(hero)hero.insertAdjacentHTML("afterend",`<section id="homeMarineWarning" class="home-marine-warning" aria-live="polite" aria-hidden="true"></section>`);else section.insertAdjacentHTML("afterbegin",`<section id="homeMarineWarning" class="home-marine-warning" aria-live="polite" aria-hidden="true"></section>`);}
section.insertAdjacentHTML("beforeend",`<section class="home-discovery"><div id="homeSearchAnchor" class="home-search-anchor"></div></section><div class="home-filter-row" aria-label="포인트 필터"><label class="home-filter-chip active"><span>⌖ 지역</span><select id="homeRegionFilter" aria-label="지역 선택" multiple size="1"><option value="">전체</option></select></label><label class="home-filter-chip"><span>♒ 지형</span><select id="homeTerrainFilter" aria-label="지형 선택" multiple size="1"><option value="">전체</option></select></label><label class="home-filter-chip"><span>☆ 추천조건</span><select id="homeRecommendFilter" aria-label="추천조건 선택" multiple size="1"><option value="">전체</option></select></label></div><button id="homeSearchButton" class="home-search-submit" type="button">검색</button><div id="homeQuickActionsCard" class="home-quick-actions-card" role="navigation" aria-label="빠른 메뉴"><button id="quickNavMySpots" class="home-quick-action-item" type="button" aria-label="나만의 스팟"><div class="home-quick-action-icon"><svg viewBox="0 0 28 28" width="28" height="28" fill="none" aria-hidden="true"><circle cx="14" cy="14" r="13" fill="#1570ef"/><path d="M14 6.5C11.5 6.5 9.5 8.5 9.5 11c0 3.8 4.5 9.5 4.5 9.5s4.5-5.7 4.5-9.5c0-2.5-2-4.5-4.5-4.5zm0 6a1.5 1.5 0 1 1 0-3 1.5 1.5 0 0 1 0 3z" fill="#ffffff"/></svg></div><span class="home-quick-action-label">나만의 스팟</span></button><a id="quickNavIndoorDiving" class="home-quick-action-item" href="./indoor-diving.html" aria-label="실내 다이빙" style="text-decoration:none"><div class="home-quick-action-icon"><svg viewBox="0 0 32 32" width="28" height="28" fill="none" aria-hidden="true"><circle cx="9" cy="20" r="3.5" fill="#1570ef"/><path d="M7 18.5c-.8 0-1.5-.7-1.5-1.5v-4c0-.8.7-1.5 1.5-1.5h1.2" stroke="#1570ef" stroke-width="1.8" stroke-linecap="round"/><path d="M11 18l5-5c1.2-1.2 3.1-1.2 4.3 0l2 2" stroke="#1570ef" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/><path d="M12.5 16.5l2.5 2.5" stroke="#1570ef" stroke-width="2" stroke-linecap="round"/><path d="M20.5 11.5l4.5-4.8c.7-.7 1.9-.4 2.2.5l.6 3.2-5 1.8z" fill="#1570ef"/><path d="M22.5 14.5l4.5-2.2c.9-.4 2 .2 2.1 1.2l.2 3-5 .8z" fill="#1570ef"/></svg></div><span class="home-quick-action-label">실내 다이빙</span></a><button id="quickNavBuddy" class="home-quick-action-item" type="button" aria-label="버디찾기"><div class="home-quick-action-icon"><svg viewBox="0 0 24 24" width="28" height="28" fill="#1570ef" aria-hidden="true"><path d="M16 11c1.66 0 2.99-1.34 2.99-3S17.66 5 16 5c-1.66 0-3 1.34-3 3zm-8 0c1.66 0 2.99-1.34 2.99-3S9.66 5 8 5C6.34 5 5 6.34 5 8s1.34 3 3 3zm0 2c-2.33 0-7 1.17-7 3.5V19h14v-2.5c0-2.33-4.67-3.5-7-3.5zm8 0c-.29 0-.62.02-.97.05 1.16.84 1.97 1.97 1.97 3.45V19h6v-2.5c0-2.33-4.67-3.5-7-3.5z"/></svg></div><span class="home-quick-action-label">버디찾기</span></button></div><section class="home-section home-best-section"><div class="home-reference-head"><h2>오늘의 추천 BEST</h2><button class="home-inline-more" type="button" data-toggle-today hidden>더보기 ›</button></div><div id="homeTodayBest" aria-live="polite"><div class="home-empty"><strong>오늘의 바다를 확인하고 있어요.</strong>잠시만 기다려 주세요.</div></div></section><section class="home-section home-nearby-section"><div class="home-reference-head"><h2>내 주변 추천 BEST</h2><button class="home-inline-more" type="button" data-toggle-nearby hidden>더보기 ›</button></div><div id="homeNearbyBest" aria-live="polite"></div></section><section class="home-section home-nearest-section"><div class="home-reference-head"><h2>가까운 포인트</h2><button class="home-inline-more" type="button" data-toggle-nearest hidden>더보기 ›</button></div><div id="homeNearestBest" aria-live="polite"></div></section><section class="home-section home-inquiry-box-section" style="margin-top:20px;margin-bottom:6px"><button id="homeInquiryTrigger" class="home-inquiry-box" type="button" aria-label="문의하기"><div class="home-inquiry-box-content"><div class="home-inquiry-box-title"><svg viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/></svg><strong>문의하기</strong></div><p class="home-inquiry-box-desc">포인트 정보 수정 · 포인트 제보 · 기타 문의</p></div><span class="home-inquiry-box-arrow" aria-hidden="true">›</span></button></section><div id="homeAccountFooterLinks" class="home-account-footer-links" style="display:none;justify-content:center;align-items:center;gap:18px;margin:8px auto 4px;padding:2px 0;font-size:13px;color:#788b9b;"><button id="homeFooterLogoutBtn" class="home-account-footer-btn" type="button" style="border:0;background:transparent;color:#788b9b;font-size:13px;font-weight:600;cursor:pointer;padding:4px 8px;text-decoration:none;">로그아웃</button><span style="color:#cfd8dc;user-select:none;">·</span><a id="homeFooterDeleteAccountBtn" class="home-account-footer-btn" href="./account-delete.html" style="border:0;background:transparent;color:#788b9b;font-size:13px;font-weight:600;cursor:pointer;padding:4px 8px;text-decoration:none;">회원탈퇴</a></div><div class="home-policy-footer-links" style="display:flex;justify-content:center;align-items:center;gap:12px;margin:4px auto 8px;font-size:12px;color:#94a3b8;"><a href="./terms.html" style="color:#94a3b8;text-decoration:none;">SNORKY 이용약관</a><span style="color:#cbd5e1;user-select:none;">·</span><a href="./privacy.html" style="color:#94a3b8;text-decoration:none;">개인정보처리방침</a></div>`);
if(!section.isConnected)homeMountRoot.appendChild(section);

function showInitialEntryChoice(){
  const auth=window.SNORKYAuthSession;
  let loggedIn=false;
  try{
    loggedIn=auth?.isLoggedIn?.()??Boolean(JSON.parse(localStorage.getItem("snorky_auth_session_v1")||"null")?.user?.id);
  }catch(_){loggedIn=false}
  const guestSelected=auth?.hasGuestSelection?.()??localStorage.getItem("snorky_guest_selected_v1")==="true";
  if(loggedIn||guestSelected||document.getElementById("snorkyInitialEntryChoice"))return;

  const overlay=document.createElement("div");
  overlay.id="snorkyInitialEntryChoice";
  overlay.setAttribute("role","dialog");
  overlay.setAttribute("aria-modal","true");
  overlay.setAttribute("aria-labelledby","snorkyInitialEntryChoiceTitle");
  overlay.style.cssText="position:fixed;inset:0;z-index:99999;display:flex;align-items:center;justify-content:center;padding:20px;background:rgba(8,24,38,.58);";
  overlay.innerHTML=`<div style="width:min(100%,360px);padding:28px 24px;border-radius:22px;background:#fff;box-shadow:0 18px 50px rgba(8,24,38,.24);text-align:center"><img src="./public/images/snorky-symbol.png" alt="" style="width:58px;height:58px;object-fit:contain"><h2 id="snorkyInitialEntryChoiceTitle" style="margin:12px 0 8px;color:#102a43;font-size:22px">SNORKY를 시작해 볼까요?</h2><p style="margin:0 0 22px;color:#607d8b;font-size:14px;line-height:1.55">로그인하거나 게스트로 홈을 둘러볼 수 있어요.</p><a href="./login.html" style="display:flex;align-items:center;justify-content:center;width:100%;min-height:48px;border-radius:12px;background:#fee500;color:#191919;font-size:15px;font-weight:800;text-decoration:none">카카오톡으로 로그인</a><button id="snorkyContinueAsGuest" type="button" style="width:100%;min-height:48px;margin-top:10px;border:1px solid #d8e2e8;border-radius:12px;background:#fff;color:#36576d;font-size:15px;font-weight:800;cursor:pointer">게스트로 사용하기</button></div>`;
  document.body.appendChild(overlay);
  overlay.querySelector("#snorkyContinueAsGuest")?.addEventListener("click",()=>{
    if(auth?.selectGuest)auth.selectGuest();
    else localStorage.setItem("snorky_guest_selected_v1","true");
    overlay.remove();
  });
}
...
const homeRecommendLabel=section.querySelector("#homeRecommendFilter")?.closest(".home-filter-chip")?.querySelector("span");
if(homeRecommendLabel)homeRecommendLabel.textContent="편의시설";
try{window.dispatchEvent(new CustomEvent("snorky:auth-changed"))}catch(_){}
...
function todayCard(point,index){
  ...
  return`<button class="home-top-card" type="button" data-home-point="${escapeHtml(point.supabaseId||point.id)}">${image?`<img src="${escapeHtml(image)}" alt="" loading="lazy">`:'<span class="home-card-fallback"></span>'}<span class="home-card-rank${rankClass(index)}">${index+1}</span><span class="home-top-info"><strong>${escapeHtml(point.name)}</strong><span class="home-best-meta-row"><small>${escapeHtml(point.region||"전국")}</small><em>${escapeHtml(conditionDisplay)}</em></span></span></button>`;
}
function listCard(point,index){
  const image=pointImage(point);
  const conditionDisplay=formatPointCondition(point);
  return`<button class="home-rank-row" type="button" data-home-point="${escapeHtml(point.supabaseId||point.id)}"><span class="home-list-rank rank-neutral">${index+1}</span><span class="home-list-photo${image?'':' home-best-fallback'}">${image?`<img src="${escapeHtml(image)}" alt="" loading="lazy">`:""}</span><span class="home-list-copy"><strong>${escapeHtml(point.name)}</strong><span class="home-best-meta-row"><small>${escapeHtml(point.region||"전국")}</small><em>${escapeHtml(conditionDisplay)}</em></span></span><span class="home-list-chevron">›</span></button>`;
}
function nearbyCard(point,index){
  ...
  const conditionDisplay=formatPointCondition(point);
  return`<button class="home-top-card" type="button" data-home-point="${escapeHtml(point.supabaseId||point.id)}" data-home-lat="${escapeHtml(point.lat)}" data-home-lng="${escapeHtml(point.lng)}">${image?`<img src="${escapeHtml(image)}" alt="" loading="lazy">`:'<span class="home-card-fallback"></span>'}<span class="home-card-rank${rankClass(index)}">${index+1}</span><span class="home-top-info"><strong>${escapeHtml(point.name)}</strong><span class="home-best-meta-row"><small>${escapeHtml(point.region||"전국")} · ${distance}km</small><em>${escapeHtml(conditionDisplay)}</em></span></span></button>`;
}
function nearbyListCard(point,index){
  const image=pointImage(point),distance=Number.isFinite(point.distance)?point.distance.toFixed(1):"--";
  const conditionDisplay=formatPointCondition(point);
  return`<button class="home-rank-row" type="button" data-home-point="${escapeHtml(point.supabaseId||point.id)}" data-home-lat="${escapeHtml(point.lat)}" data-home-lng="${escapeHtml(point.lng)}"><span class="home-list-rank rank-neutral">${index+1}</span><span class="home-list-photo${image?'':' home-best-fallback'}">${image?`<img src="${escapeHtml(image)}" alt="" loading="lazy">`:""}</span><span class="home-list-copy"><strong>${escapeHtml(point.name)}</strong><span class="home-best-meta-row"><small>${escapeHtml(point.region||"전국")} · ${distance}km</small><em>${escapeHtml(conditionDisplay)}</em></span></span><span class="home-list-chevron">›</span></button>`;
}
...
function setHeroImage(){const hero=document.getElementById("homeHero");if(hero&&!hero.style.backgroundImage.includes("snorky-hero-freediving.jpg")){hero.style.backgroundImage="url('./public/images/snorky-hero-freediving.jpg')"}}
...
function openMapScreen(){
  if(!mapScreen.classList.contains("open")){
    try{
      const currentState=history.state&&typeof history.state==="object"?history.state:{};
      if(currentState.snorkyMapScreen!==true){
        history.pushState({...currentState,snorkyMapScreen:true},"",window.location.href);
      }
    }catch(error){
      console.warn("[SNORKY Map] history state를 추가하지 못했습니다.",error);
    }
  }
  ...
  if(navigator.geolocation){
    navigator.geolocation.getCurrentPosition(pos=>{
      ...
      saveSnorkyUserCoords(state.userCoords);
      state.hasLocation=true;
      if(snorkyMap){
...
function closeMapScreen(options={}){
  const wasOpen=mapScreen.classList.contains("open");
  const shouldReturnHistory=wasOpen&&!options.fromPopState&&history.state?.snorkyMapScreen===true;
  mapScreen.classList.remove("open");
  document.body.classList.remove("home-show-legacy");
  resetSnorkyMapToGeneral();
  setBottomActive("home");
  if(shouldReturnHistory){
    try{history.back()}catch(error){console.warn("[SNORKY Map] history 항목을 정리하지 못했습니다.",error)}
  }
}
...
document.getElementById("homeFooterLogoutBtn")?.addEventListener("click",async()=>{
  ...
  try{
    if(window.SNORKYAuthSession?.clear){
      ...
      localStorage.removeItem("snorky_guest_selected_v1");
    }
  }catch(_){}
  syncAccountFooterLinks();
  try{
