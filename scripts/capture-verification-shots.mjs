...
async function run() {
  ...
  // Wait 4s for app load
  console.log('Waiting 4s for app load...');
  ...
  console.log('Open Result:', openResult?.value);
  ...
  console.log('Back button result:', backRes?.value);
