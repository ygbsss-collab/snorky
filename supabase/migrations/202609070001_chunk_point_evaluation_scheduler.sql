-- Split point evaluation refreshes into bounded Edge Function invocations.
-- Source caches remain on their existing schedules; evaluations run after the
-- Open-Meteo Marine refresh/retry windows and once at the KST date switch.
      ...
      $job$
        ...
        select net.http_post(
          ...
          headers:=jsonb_build_object(
            ...
            'x-scheduler-token',(select decrypted_secret from vault.decrypted_secrets where name='kma_refresh_secret')
          ),
