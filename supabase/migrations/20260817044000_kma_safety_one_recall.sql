...
begin
  ...
  if coalesce((rate->>'safe')::boolean,false) is not true then raise exception 'KMA Safety recall blocked by usage guard';end if;
  perform net.http_post(
    ...
    body:='{"source":"safety-one-recall","once":true}'::jsonb,
